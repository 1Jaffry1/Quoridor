...
//        if (this.islegal()) this.placeWall(); //places wall as soon as it is built after checking that it is legal
    ...
    public Wall(int row, int column,/* double layoutX, double layoutY,*/ String allign) {
        this.row = row;
        this.column = column;
        this.allign = allign;
        double layoutX = row*10;
        double layoutY = column*10;
        if (allign.equals("h")){
            setHeight(18);
            setWidth(48);
        }
