...
public class IOF {// this is the class to read and write to and from file
    ...
    public static Game readFromFile(String gamename) {
        try {
            ...
            while (!isit) {
                line++;
                isit = br1.readLine().equals(gamename + ".game");
            }
            BufferedReader br = new BufferedReader(fr);
            for (int i = 0; i< line; i++) br.readLine();
            String game = br.readLine();
            String[] list1 = br.readLine().split(" ");
            ArrayList<String> list = new ArrayList<>(Arrays.asList(list1)); //this will add all the elements of the array to the list
